...
namespace Remato.Security
{
    ...
    public class BasicAuthenticationHandler : AuthenticationHandler<BasicAuthenticationOptions>
    {
        ...
        protected override async Task<AuthenticateResult> HandleAuthenticateAsync()
        {
            ...
            {
                new Claim(RematoConstants.UniqueTokenId, authorizationResult.User.Id),
                new Claim(ClaimTypes.Role, authorizationResult.User.IsAdmin ? RematoConstants.ManagementRole : "")
            }, Scheme.Name);
        ...
        protected override Task HandleChallengeAsync(AuthenticationProperties properties)
        {
            ...
            Response.Headers.Append(HeaderNames.WWWAuthenticate, "Basic realm=\"Remato\", charset=\"UTF-8\"");
            // Response.Headers.Append("LFS-Authenticate", "Basic realm=\"Remato\", charset=\"UTF-8\"");
